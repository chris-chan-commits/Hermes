...
What is bolt? Bolt is an open source Game Engine that is currently in development, and includes a completed 2D renderer and an audio system. The audio system is currently in development, however you can still use it, and it produces, mediocore sounds.
### Where is the code?
Well, because im an idiot, I did not commit along the way. So, it is in the zip files of the binaries.
...
###
	...
	virtual void Start() override
	{
		...
		m_Entity->AddAnimation2D(m_PlayerMovementAnimation);
	}
